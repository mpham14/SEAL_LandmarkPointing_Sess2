...
thisExp = data.ExperimentHandler(name=expName, version='',
    ...
    originPath='/Users/mettapham/Downloads/SEAL-selected/SEAL_LandmarkPointing_Sess2/SEAL_LandmarkPoint_Sess2_lastrun.py',
...
text_2 = visual.TextStim(win=win, name='text_2',
    ...
    languageStyle='LTR',
    depth=0.0);
StartBox = visual.TextBox2(
     win, text='Start', font='Open Sans',
...
# keep track of which components have finished
instructionComponents = [text_2, StartBox, mouse]
...
while continueRoutine:
    ...
    # *StartBox* updates
    if StartBox.status == NOT_STARTED and tThisFlip >= 0.0-frameTolerance:
        # keep track of start time/frame for later
        StartBox.frameNStart = frameN  # exact frame index
        StartBox.tStart = t  # local t and not account for scr refresh
        StartBox.tStartRefresh = tThisFlipGlobal  # on global time
        win.timeOnFlip(StartBox, 'tStartRefresh')  # time at next scr refresh
        # add timestamp to datafile
        thisExp.timestampOnFlip(win, 'StartBox.started')
...
for thisTrial in trials:
    ...
    # keep track of which components have finished
    trialComponents = [image_2, text_4, button]
